...
悪い例(絶対に出さない): 「${a}と${b}について調べる」(漠然としていて問いがない)/「${a}で${b}を作ってみる」(工作で終わり、確かめることがない)/「${a}の歴史をまとめる」(検索で分かる)/「友だちにアンケートする」だけの案(人数集めが前提になる)

良い例の水準: 「折り紙」×「虫」→「テントウムシの羽は何回折りたたまれている？ 折り紙で同じ折り方を再現すると何が難しい？」(世界一になった高校生の研究につながった問い)
