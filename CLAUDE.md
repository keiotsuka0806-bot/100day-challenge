...
| TrainDex | `開発部/train-dex/` | デプロイ済み | Vanilla JS / PWA / Vercel関数+OpenAI Vision。RideDexエンジン流用の鉄道図鑑（🚄新幹線/🚃在来線・私鉄/🚋路面電車）。事業者+形式/系列+登場年+確度+ユーザー訂正/レア演出/実績/写り込んだ顔の自動ぼかし。現実世界図鑑シリーズ第2弾（https://traindex-kei.vercel.app） |
